...
module.exports = async (client) => {
    client.on('messageCreate', async (message) => {
        ...
        try {
            ...
            let scot = 0
            let slink = 'https://discord.gg/flingo'
                    ...
                    .send({
                        embeds: [
                            new MessageEmbed()
                                .setColor(`0xf9fd17`)
                                .setDescription(
                                    `Your Premium Has Got Expired.\nTotal **\`${scot}\`** Servers [Premium](https://discord.gg/flingo) was removed.\nClick [here](https://discord.gg/flingo) To Buy [Premium](https://discord.gg/flingo).`
                                )
                        ],
                        components: [premrow]
                    })
                            ...
                            .send({
                                embeds: [
                                    new MessageEmbed()
                                        .setColor(`0xf9fd17`)
                                        .setDescription(
                                            `Your Premium Has Got Expired.\nTotal **\`${scount}\`** Servers [Premium](https://discord.gg/flingo) was removed.\nClick [here](https://discord.gg/flingo) To Buy [Premium](https://discord.gg/flingo).`
                                        )
                                ],
                                components: [premrow]
                            })
            ...
            const row = new MessageActionRow().addComponents(
                ...
                new MessageButton()
                    .setLabel(`Support`)
                    .setStyle('LINK')
                    .setURL(`https://discord.com/invite/DUYhwqD5cp`)
            )
            ...
            if (
                !'1141682510380666962'.includes(message.author.id) &&
                !uprem &&
                !sprem
            ) {
                const row = new MessageActionRow().addComponents(
                    ...
                    new MessageButton()
                        .setLabel('Premium')
                        .setStyle('LINK')
                        .setURL('https://discord.gg/flingo')
                )
                    ...
                    if (now < expirationTime) {
                        ...
                        if (commandCount > commandLimit) {
                            ...
                            const ricky = new MessageEmbed()
                                ...
                                .addField(
                                    'Support Server',
                                    '[Join our support server](https://discord.gg/flingo )',
                                    true
                                )
                                .setTimestamp()
